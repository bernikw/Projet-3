...
final class Comment
{
    ...
    public function __construct(int $id, string $username, string $textComment,string $dateComment, int $valid, int $idPost)
    {
        $this->id = $id;
    ...
    public function setTextCoemment(string $textComment): self
    {
